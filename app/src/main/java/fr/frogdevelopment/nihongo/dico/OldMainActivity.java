...
//        NihonGoRestServiceFactory.getNihonGoClient().search("fre", query).enqueue(new Callback<List<Search>>() {
//            @Override
//            public void onResponse(@NonNull Call<List<Search>> call, @NonNull Response<List<Search>> response) {
//
//                if (response.code() != HttpURLConnection.HTTP_OK) {
//                    Toasty.error(OldMainActivity.this, "Response code : " + response.code()).show();
//                } else {
//                    List<Search> searches = response.body();
//
//                    mAdapter = new ResearchByGlossAdapter(OldMainActivity.this, searches);
//
//                    mListView.setAdapter(mAdapter);
//
//                    SearchRecentSuggestions suggestions = new SearchRecentSuggestions(OldMainActivity.this, NihonGoDicoContentProvider.AUTHORITY, NihonGoDicoContentProvider.MODE);
//                    suggestions.saveRecentQuery(query, String.valueOf(searches.size() + " results"));
//
...
//                Toasty.error(OldMainActivity.this, "Call failure").show();
//            }
//        });
