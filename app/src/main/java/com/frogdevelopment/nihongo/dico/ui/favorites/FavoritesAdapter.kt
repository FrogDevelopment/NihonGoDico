...
class FavoritesAdapter(context: Context, private val listener: OnEntryClickListener, private val entries: List<EntryDetails>) : RecyclerView.Adapter<FavoritesAdapter.ViewHolder>() {
