...
public class FavoritesContract implements BaseColumns {
    ...
    private static final String SQL_CREATE = "CREATE TABLE favorites (rowid INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sense_id INTEGER NOT NULL, FOREIGN KEY(sense_id) REFERENCES sense(sense_id))";
