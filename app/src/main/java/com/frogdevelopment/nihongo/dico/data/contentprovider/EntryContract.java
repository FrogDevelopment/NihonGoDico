...
public class EntryContract implements BaseColumns {
    ...
    private static final String SQL_CREATE_VIEW  = "CREATE VIEW `EntryDetails` AS SELECT entries.kanji, entries.kana, entries.reading, senses.sense_seq, senses.pos, senses.field, senses.misc, senses.info, senses.dial, senses.gloss FROM entries INNER JOIN senses ON senses.entry_seq = entries.entry_seq";
