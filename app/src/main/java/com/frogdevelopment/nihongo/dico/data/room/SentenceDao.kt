...
interface SentenceDao {
    ...
    @Transaction
    @Query("SELECT japanese_sentence, translation_sentence FROM sentences INNER JOIN fts_sentences ON (sentences.rowid = fts_sentences.docid) WHERE fts_sentences MATCH :term")
